...
function getDisambiguation(move: Move, board: (ChessPiece | null)[][], moveHistory: Move[]): string {
...
export function formatMoveNumber(moveIndex: number, isWhiteMove: boolean): string {
